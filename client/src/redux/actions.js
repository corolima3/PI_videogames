...
export const getAllVideogames=()=>{
    return async (dispatch) => {
        try {
            const getAll = await axios.get("http://localhost:3001/videogames");
...
export const getAllGenres=()=>{
    return async (dispatch) => {
        try {
            const getGenres = await axios.get("http://localhost:3001/genres");
...
export const createVideogame = (userData) =>{
    return async (dispatch) => {
        try {
            const newCreate = await axios.post("http://localhost:3001/videogames", userData);
